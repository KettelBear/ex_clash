defmodule ExClash.Player do
  ...
  ## Examples
      ...
      {:error, :not_found}
  """
  @spec details(tag :: ExClash.tag(), opts :: Keyword.t()) :: __MODULE__.t() | {:error, atom()}
  ...
  defp format(api_player) do
    ...
    %__MODULE__{
      ...
      player_house: ExClash.PlayerHouse.format(player_house),
      ...
      legend_statistics: ExClash.LegendStats.format(legend_statistics),
